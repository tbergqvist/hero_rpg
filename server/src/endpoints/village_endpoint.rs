...
#[post("/quests/<id>")]
pub fn accept_quest(id: i32, game_state: State<TsGameState>, player_state: TsPlayerState, config: State<Config>) -> Result<Json<game_screen::GameScreen>, rocket::response::Failure> {
